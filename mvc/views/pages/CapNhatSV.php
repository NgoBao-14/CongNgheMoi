                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    ...
                                    <input type="text" class="form-control" id="stt" placeholder="Số thứ tự">
                                    
                                </div>
                                
                                <div class="form-floating">
                                    <label for="mssv">MSSV</label>
                                    <input type="text" class="form-control" id="mssv" placeholder="Mã số sinh viên" readonly>
                                   
                                </div>
                                
                                <div class="form-floating">
                                  <label for="hoDem">Họ đệm</label>
                                    <input type="text" class="form-control" id="hoDem" placeholder="Họ và tên đệm">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-floating">
                                    ...
                                    <input type="text" class="form-control" id="chuyenNganh" placeholder="Chuyên ngành">  
                                </div>
                            </div>
                        </div>
