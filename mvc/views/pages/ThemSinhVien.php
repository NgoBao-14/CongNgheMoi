...
<div class="content-wrapper">
    ...
    <div class="container-fluid p-4">
        ...
        <div class="page-header">
            <h1 class="h3 fw-bold mb-2" style="color: #0F172A;">Thêm sinh viên mới</h1>
            <p class="text-muted mb-0">Điền thông tin để thêm sinh viên vào hệ thống</p>
        </div>';
...
if ($rs) {
    echo '
        <div class="alert alert-success" style="border-radius: 0.75rem; border-left: 4px solid #10B981;">
            ...
            <strong>Thành công!</strong> Đã thêm sinh viên mới vào hệ thống.
        </div>';
}
            ...
            <form method="POST" action="">
                <div class="row g-4">
                    <div class="col-md-4">
                        ...
                        <input type="text" name="masv" class="form-control" value="' . $masv . '" readonly>
                ...
                <div class="row g-4 mt-2">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="lop" class="form-control" placeholder="DHKTPM17A" required>
                    </div>
...
echo '                  </select>
                ...
                <div class="row g-4 mt-2">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="email" name="email" class="form-control" placeholder="sinhvien@email.com" required>
                    </div>
                </div>
                ...
                <div class="d-flex gap-2 justify-content-end mt-4 pt-4" style="border-top: 1px solid #E2E8F0;">
                    ...
                    <button type="submit" name="btn_them" class="btn btn-submit">
                        <i class="fas fa-check me-2"></i>Thêm sinh viên
                    </button>
                </div>
            </form>
        </div>
