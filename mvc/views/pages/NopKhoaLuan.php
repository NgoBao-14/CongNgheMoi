        ...
        <div class="card mb-4">
            <div class="card-body">
                <div class="d-flex align-items-center mb-3">
                    ...
                    <div>
                        <h1 class="page-title mb-0">NỘP QUYỂN KHÓA LUẬN</h1>
                    </div>
                </div>
                                ...
                                <div class="d-flex flex-column h-100">';
                                    foreach ($khoaluan as $r) {
                                        ...
                                        echo '<div class="file-item d-flex align-items-center mb-2">
                                                ...
                                                <a href="public/khoaluan/' . htmlspecialchars($fileName) . '" download>' . htmlspecialchars($fileName) . '</a>
                                            </div>';
                                    }
echo'                           </div>
                            </div>
